  ...
  <div class="col-md-12">
    ...
    <p>
      <b>6) Run the EHRServer</b><br/></br>
       ...
       Use admin / admin / 1234 (username, password, organization) to login, and you are ready to go. That is the 
       administration user, so it has special access to all the functionalities of the EHRServer.<br/></br>

       For a more constrained user, you can use this login: orgman / orgman / 1234  (username, password, organization). 
