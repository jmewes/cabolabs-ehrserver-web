<div class="row">
  <div class="col-lg-8 col-lg-offset-2 text-center main">
    ...
    <h2 class="lead">Focus on features, not on back-end.
    The open clinical data repository, compliant
    with the openEHR standard. Now on the cloud.</h2>
...
<div class="row">
  <div class="col-lg-4">
    ...
    and integrated everything in the unique Electronic Health Record of each patient.</p>
...
<div class="row">
  <div class="col-lg-6">
    ...
    <p class="center v-air"><a class="btn btn-primary" href="get_started.html" role="button">Get Started &raquo;</a></p>
 </div>
  <div class="col-lg-6">
    ...
    <p class="center v-air"><a class="btn btn-primary" href="learn.html" role="button">Continue learning &raquo;</a></p>
